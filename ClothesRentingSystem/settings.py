"""
Django settings for ClothesRentingSystem project.
...
INSTALLED_APPS = [
    ...
    'RentClothes.apps.RentClothesConfig',
...
ROOT_URLCONF = 'ClothesRentingSystem.urls'
...
WSGI_APPLICATION = 'ClothesRentingSystem.wsgi.application'
